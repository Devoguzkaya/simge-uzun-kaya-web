...
const WhatsAppButton = () => {
    return (
        ...
        >
            <div className="absolute right-full mr-3 bg-white text-text-main px-4 py-2 rounded-xl text-sm font-bold shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                Bir sorunuz mu var?
            </div>
            <svg
                viewBox="0 0 24 24"
