        ...
        <div className="bg-white dark:bg-stone-800 rounded-[2rem] p-8 md:p-12 shadow-xl shadow-orange-900/5 mb-16 flex flex-col md:flex-row items-center justify-between gap-8 border border-orange-100 dark:border-stone-700 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-xl text-center md:text-left">
            ...
            <div className="flex flex-col gap-3 items-start">
              <a className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-orange-100 dark:bg-stone-700 dark:border-stone-600 hover:bg-orange-50 dark:hover:bg-stone-600 transition-colors text-text-main dark:text-white font-medium shadow-sm w-full sm:w-auto" href="tel:+905522610057">
                <span className="material-symbols-outlined text-primary">call</span>
                0552 261 00 57
              </a>
              <a className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-orange-100 dark:bg-stone-700 dark:border-stone-600 hover:bg-orange-50 dark:hover:bg-stone-600 transition-colors text-text-main dark:text-white font-medium shadow-sm w-full sm:w-auto" href="tel:+903682300212">
                <span className="material-symbols-outlined text-primary">call</span>
                0368 230 02 12
              </a>
              <a className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-orange-100 dark:bg-stone-700 dark:border-stone-600 hover:bg-orange-50 dark:hover:bg-stone-600 transition-colors text-text-main dark:text-white font-medium shadow-sm w-full sm:w-auto" href="mailto:info@simgeuzunkaya.com">
                <span className="material-symbols-outlined text-primary">mail</span>
                info@simgeuzunkaya.com
              </a>
            </div>
          </div>
          <div className="relative z-10 w-full sm:w-auto">
            <a
              href="https://www.esperayasam.com/randevu"
              target="_blank"
        ...
        <div className="border-t border-orange-200 dark:border-stone-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <a className="w-10 h-10 rounded-full bg-white dark:bg-stone-800 flex items-center justify-center text-stone-400 hover:text-primary hover:shadow-md transition-all border border-orange-50 dark:border-stone-700"
              href="https://www.instagram.com/sinop.psikolojikdanismanlik/"
              target="_blank"
              rel="noopener noreferrer"
